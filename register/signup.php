<?php
    ...
    if (!empty($_POST)) {   //POST送信があったときに以下を実行
      ...
      <div class="col-xs-8 col-xs-offset-2 thumbnail">
        ...
        <form method="POST" action="signup.php" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <?php } elseif(isset($errors['name']) && $errors['name'] == 'deplicate') { ?>
            <p class="text-danger">既に登録されているユーザー名です</p>  
            <?php } ?>
          ...
          <div class="form-group">
            ...
            <?php } elseif(isset($errors['email']) && $errors['email'] == 'deplicate') { ?>
            <p class="text-danger">既に登録されているメールアドレスです　byおかゆ</p>
            <?php } ?>
